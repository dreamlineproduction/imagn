                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="fucking-images/head-banner.jpg" class="d-block w-100" alt="...">
                        </div>
            ...
            <div class="profile-card-top-section">
                <div class="row">
                    <div class="user-profile-avatar d-flex justify-content-center">
                        ...
                        <!-- <img src="fucking-images/dev-chatterjee-seo-expert.jpg"  class="img-fluid img-thumbnail" alt="..."> -->
                ...
                <div class="user-top-information">
                    <div class="row">
                        ...
                        <div class="col-md-4 user-top-center-side-widget border-end text-center px-4">
                            ...
                            <div class="user-hobby-section">

                                <p> <i class="fas fa-home"></i> Lives In: New York, NY</p>

                                <p> <i class="fas fa-guitar"></i> Jazz Guitar, Pool, Video Gaming</p>
                        ...
                        <div class="col-md-4 user-top-left-side-widget px-4">
                            ...
                            <a href="www.imagn.world" target="_blank"><i class="fas fa-external-link-alt"></i>
                                www.imagn.world</a>
                            <p>A new world order to celebrate the political and economic paradigm of the Artist's Dream.
                            </p>
        ...
        <section>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center my-consciousness">
                        <h1>My Consciousness</h1>
                    </div>
                </div>
                <div class="row mt-5">

                    <div class="col-md-8 p-0">
                        <div class="my-consciousness-top-nav">
                            <div class="card bg-light-black rounded-0 text-white">
                    ...
                    <div class="col-md-4 p-0">
                        <div class="my-consciousness-left-section bg-black text-white">
                            <div class="widget-1">
